...
export default function Quote() {
  ...
  return (
    ...
    ref={cardRef}
     ...
     className="flex relative overflow-hidden py-[64px] mx-auto border bg-center rounded-xl bg-quoteBg h-[400px] lg:h-[506px] px-2 lg:px-[126px] bg-no-repeat bg-cover md:w-full ">
